export function MessageIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-mediumdarkgray focus:text-black">
...
export function CommunityIconDark() {
    return (
        <img src="/assets/community-dark.svg" />
    )
}
export function SettingsIconLight() {
    return (
        <img src="/assets/settings-light.svg" />
    )
}
export function SettingsIconDark() {
    return (
        <img src="/assets/settings-dark.svg" />
    )
}
...
export function OptionsIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 stroke-3 stroke-[#3b3b3b] cursor-pointer">
...
export function SearchIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"  className="w-4 h-4 stroke-2 stroke-[#3b3b3b] absolute top-5  left-6 cursor-pointer">
